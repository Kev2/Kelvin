...
begin
  ...
  // angle
     for s := 1 to 16 do
     if pos(s1, lowercase(tangle[s].tu)) > 0 then begin
      srch[m] := s;
      m := m + 1;
     end;
     srch[m] := 0;
  ...
  // freq
     for s := 1 to 14 do
     if pos(s1, lowercase(tavel[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Area
     for s := 1 to 57 do
     if pos(s1, lowercase(tarea[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Atomic physics
     for s := 1 to 17 do
     if pos(s1, lowercase(taphys[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Computer data
     for s := 1 to 14 do
     if pos(s1, lowercase(tcdata[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Computer flow rate
     for s := 1 to 6 do
     if pos(s1, lowercase(tcdflow[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Computer numbers
     for s := 1 to 26 do
     if pos(s1, lowercase(tcnum[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Current loop
     for s := 1 to 4 do
     if pos(s1, lowercase(tcloop[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Density
     for s := 1 to 25 do
     if pos(s1, lowercase(tdens[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // E capacitance
     for s := 1 to 7 do
     if pos(s1, lowercase(tcap[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // E charge
     for s := 1 to 9 do
     if pos(s1, lowercase(tech[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // E current
     for s := 1 to 9 do
     if pos(s1, lowercase(tcur[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // E inductance
     for s := 1 to 7 do
     if pos(s1, lowercase(tind[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // E resistance and conductance
     for s := 1 to 14 do
     if pos(s1, lowercase(trcon[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // E voltage
     for s := 1 to 9 do
     if pos(s1, lowercase(tvolt[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // EMR radiation
     for s := 1 to 14 do
     if pos(s1, lowercase(temr[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // NRG/work
     for s := 1 to 38 do
     if pos(s1, lowercase(twrk[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Flow dry
     for s := 1 to 6 do
     if pos(s1, lowercase(tflowd[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Flow liquid
     for s := 1 to 6 do
     if pos(s1, lowercase(tflowl[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Force
     for s := 1 to 16 do
     if pos(s1, lowercase(tforce[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Fuel consumption
     for s := 1 to 6 do
     if pos(s1, lowercase(tfuelc[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Illumination
     for s := 1 to 8 do
     if pos(s1, lowercase(tillum[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Length
     for s := 1 to 128 do
     if pos(s1, lowercase(tlen[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Luminance
     for s := 1 to 13 do
     if pos(s1, lowercase(tlumin[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Luminous flux
     for s := 1 to 2 do
     if pos(s1, lowercase(tlflux[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Luminous intensity
     for s := 1 to 3 do
     if pos(s1, lowercase(tlint[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Magnetic field strength
     for s := 1 to 6 do
     if pos(s1, lowercase(tmfs[s].tu)) > 0 then  begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
  ...
  // Magnetic flux
     for s := 1 to 6 do
     if pos(s1, lowercase(tmflux[s].tu)) > 0 then begin
        srch[m] := s;
        m := m + 1;
     end;
     srch[m] := 0;
   ...
   // Magnetic flux density
      for s := 1 to 11 do
      if pos(s1, lowercase(tmfd[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Magnetomotive force
      for s := 1 to 5 do
      if pos(s1, lowercase(tmmf[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Mass
      for s := 1 to 84 do
      if pos(s1, lowercase(tmass[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Music
      for s := 1 to 5 do
      if pos(s1, lowercase(tmus[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Power
      for s := 1 to 20 do
      if pos(s1, lowercase(tpower[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Pref and suff
      for s := 1 to 82 do
      if pos(s1, lowercase(tprefx[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Pressure and stress
      for s := 1 to 42 do
      if pos(s1, lowercase(tpress[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Shoe size
      for s := 1 to 8 do
      if pos(s1, lowercase(tshoe[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Specific heat
      for s := 1 to 4 do
      if pos(s1, lowercase(tsheat[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Speed/vel
      for s := 1 to 14 do
      if pos(s1, lowercase(tspeed[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Temperature
      for s := 1 to 7 do
      if pos(s1, lowercase(ttemp[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Temp diff
      for s := 1 to 5 do
      if pos(s1, lowercase(ttdiff[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Thermal conductance area
      for s := 1 to 5 do
      if pos(s1, lowercase(ttcona[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Thermal cond linear
      for s := 1 to 4 do
      if pos(s1, lowercase(ttconl[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Thermal resistance
      for s := 1 to 5 do
      if pos(s1, lowercase(ttres[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Time
      for s := 1 to 37 do
      if pos(s1, lowercase(ttime[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Torque
      for s := 1 to 17 do
      if pos(s1, lowercase(ttque[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Viscosity dynamic
      for s := 1 to 7 do
      if pos(s1, lowercase(tvisd[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Viscosity Kinematic
      for s := 1 to 6 do
      if pos(s1, lowercase(tvisk[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Volume and dry capacity
      for s := 1 to 20 do
      if pos(s1, lowercase(tvold[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      srch[m] := 0;
   ...
   // Volume and liquid capacity
      for s := 1 to 46 do
      if pos(s1, lowercase(tvoliq[s].tu)) > 0 then begin
         srch[m] := s;
         m := m + 1;
      end;
      esrch.SetFocus;
...
begin
     ...
     if m - 49 > 0 then begin
        if l = m then begin lbox := 0; l := 0; end;

        while srch[l] = 0 do begin
              l := l + 1;
              lbox := lbox + 1;
              if l = m then begin
                 lbox := 0;
        ...
        if stringgrid1.Row = srch[l] then begin
           ed1.edi('', 110, 380, False);
           labl1.labl(stringgrid1.Cells[0, srch[l]], 115, 550);
...
// Grid filling
  ...
  // Angle
     if listbox1.Selected[1] then begin
        memo1.Clear;
        stringgrid1.RowCount := 17;
        for gridlin := 1 to 16 do begin
  ...
  // Avel Freq
     if listbox1.Selected[2] then begin
        memo1.Clear;
        stringgrid1.RowCount := 15;
        for gridlin := 1 to 14 do begin
  ...
  // Atomic Physics
     if listbox1.Selected[4] then begin
        memo1.Clear;
        stringgrid1.RowCount := 18;
        for gridlin := 1 to 17 do begin
  ...
  // Computer Data
     if listbox1.Selected[5] then begin
        memo1.Clear;
        stringgrid1.RowCount := 15;
        for gridlin := 1 to 14 do begin
  ...
  // CD Flow rate
     if listbox1.Selected[6] then begin
        memo1.Clear;
        stringgrid1.RowCount := 7;
        for gridlin := 1 to 6 do begin
  ...
  // Computer Numbers
     if listbox1.Selected[7] then begin
        memo1.Clear;
        stringgrid1.RowCount := 27;
        for gridlin := 1 to 26 do begin
  ...
  // Current loop
     if listbox1.Selected[8] then begin
        memo1.Clear;
        stringgrid1.RowCount := 5;
        for gridlin := 1 to 4 do begin
  ...
  // Density
     if listbox1.Selected[9] then begin
        memo1.Clear;
        stringgrid1.RowCount := 26;
        for gridlin := 1 to 25 do begin
  ...
  // E capacitance
     if listbox1.Selected[10] then begin
        memo1.Clear;
        stringgrid1.RowCount := 8;
        for gridlin := 1 to 7 do begin
  ...
  // E charge
     if listbox1.Selected[11] then begin
        memo1.Clear;
        stringgrid1.RowCount := 10;
        for gridlin := 1 to 9 do begin
  ...
  // E current
     if listbox1.Selected[12] then begin
        memo1.Clear;
        stringgrid1.RowCount := 10;
        for gridlin := 1 to 9 do begin
  ...
  // E inductance
     if listbox1.Selected[13] then begin
        memo1.Clear;
        stringgrid1.RowCount := 8;
        for gridlin := 1 to 7 do begin
  ...
  // E resistance and conductance
     if listbox1.Selected[14] then begin
        memo1.Clear;
        stringgrid1.RowCount := 15;
        for gridlin := 1 to 14 do begin
  ...
  // E voltage
     if listbox1.Selected[15] then begin
        memo1.Clear;
        stringgrid1.RowCount := 10;
        for gridlin := 1 to 9 do begin
  ...
  // EMR
     if listbox1.Selected[16] then begin
        memo1.Clear;
        stringgrid1.RowCount := 15;
        for gridlin := 1 to 14 do begin
  ...
  // NRG/ Work
     if listbox1.Selected[17] then begin
        memo1.Clear;
        stringgrid1.RowCount := 39;
        for gridlin := 1 to 38 do begin
  ...
  // Flow dry
     if listbox1.Selected[18] then begin
        memo1.Clear;
        stringgrid1.RowCount := 7;
        for gridlin := 1 to 6 do begin
  ...
  // Flow liq
     if listbox1.Selected[19] then begin
        memo1.Clear;
        stringgrid1.RowCount := 7;
        for gridlin := 1 to 6 do begin
  ...
  // Force
     if listbox1.Selected[20] then begin
        memo1.Clear;
        stringgrid1.RowCount := 17;
        for gridlin := 1 to 16 do begin
  ...
  // Fuel consuption
     if listbox1.Selected[21] then begin
        memo1.Clear;
        stringgrid1.RowCount := 7;
        for gridlin := 1 to 6 do begin
  ...
  // Illumination
     if listbox1.Selected[22] then begin
        memo1.Clear;
  ...
  // Length
     if listbox1.Selected[23] then begin
        memo1.Clear;
        stringgrid1.RowCount := 129;
        for gridlin := 1 to 128 do begin
  ...
  // Luminance
     if listbox1.Selected[24] then begin
        memo1.Clear;
        stringgrid1.RowCount := 14;
        for gridlin := 1 to 13 do begin
  ...
  // Luminous flux
     if listbox1.Selected[25] then begin
        memo1.Clear;
        stringgrid1.RowCount := 3;
        for gridlin := 1 to 2 do begin
  ...
  // Luminous intensity
     if listbox1.Selected[26] then begin
        memo1.Clear;
        stringgrid1.RowCount := 4;
        for gridlin := 1 to 3 do begin
  ...
  // Mag field strength
     if listbox1.Selected[27] then begin
        memo1.Clear;
        stringgrid1.RowCount := 7;
        for gridlin := 1 to 6 do begin
  ...
  // Mag flux
     if listbox1.Selected[28] then begin
        memo1.Clear;
        stringgrid1.RowCount := 7;
        for gridlin := 1 to 6 do begin
  ...
  // Magnetic flux density
     if listbox1.Selected[29] then begin
        memo1.Clear;
        stringgrid1.RowCount := 12;
        for gridlin := 1 to 11 do begin
  ...
  // Magnetomotive force
     if listbox1.Selected[30] then begin
        memo1.Clear;
        stringgrid1.RowCount := 6;
        for gridlin := 1 to 5 do begin
  ...
  // Mass
     if listbox1.Selected[31] then begin
        memo1.Clear;
        stringgrid1.RowCount := 85;
        for gridlin := 1 to 84 do begin
  ...
  // Musical notes
     if listbox1.Selected[32] then begin
        memo1.Clear;
        stringgrid1.RowCount := 6;
        for gridlin := 1 to 5 do begin
  ...
  // Power
     if listbox1.Selected[33] then begin
        memo1.Clear;
        stringgrid1.RowCount := 21;
        for gridlin := 1 to 20 do begin
  ...
  // Prefixes
     if listbox1.Selected[34] then begin
        memo1.Clear;
        stringgrid1.RowCount := 83;
        for gridlin := 1 to 82 do begin
  ...
  // Pressure and stress
     if listbox1.Selected[35] then begin
        memo1.Clear;
        stringgrid1.RowCount := 43;
        for gridlin := 1 to 42 do begin
  ...
  // shoes
     if listbox1.Selected[36] then begin
        stringgrid1.Clear;
  ...
  // Specific heat
     if listbox1.Selected[37] then begin
        memo1.Clear;
        stringgrid1.RowCount := 5;
        for gridlin := 1 to 4 do begin
  ...
  // Speed
     if listbox1.Selected[38] then begin
        memo1.Clear;
        stringgrid1.RowCount := 15;
        for gridlin := 1 to 14 do begin
  ...
  // Temperature
     if listbox1.Selected[39] then begin
        memo1.Clear;
        stringgrid1.RowCount := 8;
        for gridlin := 1 to 7 do begin
  ...
  // Temp difference
     if listbox1.Selected[40] then begin
        memo1.Clear;
        stringgrid1.RowCount := 6;
        for gridlin := 1 to 5 do begin
  ...
  // thermal conductance area
     if listbox1.Selected[41] then begin
        memo1.Clear;
        stringgrid1.RowCount := 6;
        for gridlin := 1 to 5 do begin
  ...
  // thermal cond linear
     if listbox1.Selected[42] then begin
        memo1.Clear;
        stringgrid1.RowCount := 5;
        for gridlin := 1 to 4 do begin
  ...
  // thermal resistance
     if listbox1.Selected[43] then begin
        memo1.Clear;
        stringgrid1.RowCount := 6;
        for gridlin := 1 to 5 do begin
  ...
  // time
     if listbox1.Selected[44] then begin
        memo1.Clear;
        stringgrid1.RowCount := 38;
        for gridlin := 1 to 37 do begin
  ...
  // Torque
     if listbox1.Selected[45] then begin
        memo1.Clear;
        stringgrid1.RowCount := 18;
        for gridlin := 1 to 17 do begin
  ...
  // viscosity dynamic
     if listbox1.Selected[46] then begin
        memo1.Clear;
        stringgrid1.RowCount := 8;
        for gridlin := 1 to 7 do begin
  ...
  // Viscosity kinematic
     if listbox1.Selected[47] then begin
        memo1.Clear;
        stringgrid1.RowCount := 7;
        for gridlin := 1 to 6 do begin
  ...
  // Vol dry
     if listbox1.Selected[48] then begin
        memo1.Clear;
        stringgrid1.RowCount := 21;
        for gridlin := 1 to 20 do begin
  ...
  // VOl liq
     if listbox1.Selected[49] then begin
        memo1.Clear;
        stringgrid1.RowCount := 47;
        for gridlin := 1 to 46 do begin
...
// Creation of dynamic labels and text boxes
  case z of
    ...
    begin // first click: One dynamic label
      ...
      ed1.edi('', 70, 380, False);
      labl1.labl(dynl1, 75, 550);
      z := 1; adit[1].SetFocus;
    end;
    1:
    begin //second click: Second dynamic label
      fl := 2;
      ed2.edi(snd1, 100, 380, False);
      labl2.labl(dynl1, 105, 550);
      adit[1].SetFocus; adit[1].SelectAll; dynl2 := dynl1; snd2 := snd1; z := 3;
    end;
    2:
    begin // not used
      fl := 1;
      ed1.edi(snd2, 70, 380, False);
      labl1.labl(dynl1, 75, 550);
      s := 3;
    end;
    3:
...
After that, dynamic text boxes are updated.
      ...
      // Area
      3: begin
         for llen := 1 to 57 do begin
             if alabel[s].Caption = tarea[llen].tu then begin
      ...
      // Current loop
      8: begin
         for llen := 1 to 4 do begin
             if alabel[s].Caption = tcloop[llen].tu then begin
             milm := tcloop[llen].tcons * ninput1;
             for gridlin := 1 to 4 do begin
                 if (llen < 4) then begin
      ...
      16: begin
          for llen := 1 to 14 do
              if alabel[s].Caption = temr[llen].tu then begin
      ...
      // Luminance
      24: begin
          for llen := 1 to 13 do begin
              if alabel[s].Caption = tlumin[llen].tu then begin
...
{Temperature is a special case because uses functions instead numeric constants.}
      ...
      39: begin
          ...
          if alabel[s].Caption = 'Celsius' then begin
          ...
          if alabel[s].Caption = 'Celsius absolute' then begin
          ...
          if alabel[s].Caption = 'Fahrenheit' then begin
          ...
          if alabel[s].Caption = 'Fahrenheit absolute' then begin
          ...
          if alabel[s].Caption = 'Kelvin' then begin
             stringgrid1.Cells[1, 5] := sinput1;          // Kelvin
             stringgrid1.Cells[1, 1] := floattostr(strtofloat(a)-273.15);    // Celsius
             stringgrid1.Cells[1, 2] := sinput1;  // Celsius abs
             stringgrid1.Cells[1, 3] := floattostr(ctof.ctof(strtofloat(stringgrid1.Cells[1, 1])));        // Fah
      ...
      40: begin
          for llen := 1 to 5 do begin
              if alabel[s].Caption = ttdiff[llen].tu then begin
                  ...
                  if (llen = 1) then
                     if (gridlin = 2) or (gridlin = 3) then
                        stringgrid1.Cells[1, gridlin] := floattostr(milm * ttdiff[gridlin].tcons)
                         ...
                         stringgrid1.Cells[1, gridlin] := floattostr(milm / ttdiff[gridlin].tcons);
                  if (llen = 2) or (llen = 3) then begin
...
if listbox1.ItemIndex= 7  then begin
  ...
  for validate:= 1 to length(a) do
    ...
    for llen := 1 to 25 do
        if alabel[s].Caption = tcnum[llen].tu then begin
           for gridlin := 1 to 25 do begin
